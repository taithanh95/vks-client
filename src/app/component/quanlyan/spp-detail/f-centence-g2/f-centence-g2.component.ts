...
@Component({
  selector: 'app-f-centence-g2',
  templateUrl: './f-centence-g2.component.html',
  styleUrls: ['./f-centence-g2.component.scss']
})
export class FCentenceG2Component implements OnInit {
  @Input() sppCase: any;
  @Input() datas: any[];
  @Input() register: any;
