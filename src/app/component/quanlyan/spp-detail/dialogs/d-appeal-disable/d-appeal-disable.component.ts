...
@Component({
  selector: 'app-d-appeal-disable',
  templateUrl: './d-appeal-disable.component.html',
  styleUrls: ['./d-appeal-disable.component.scss']
})
export class DAppealDisableComponent implements OnInit, OnChanges {
