...
@Component({
    selector: 'app-d-sppspcpol-disable',
    templateUrl: './d-sppspcpol-disable.component.html',
    styleUrls: ['./d-sppspcpol-disable.component.scss']
})
export class DSppspcpolDisableComponent implements OnInit, OnChanges {
  @Input() userfor: any;
