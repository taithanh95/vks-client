...
@Component({
  selector: 'app-d-centence-g1-disable',
  templateUrl: './d-centence-g1-disable.component.html',
  styleUrls: ['./d-centence-g1-disable.component.scss']
})
export class DCentenceG1DisableComponent implements OnInit, OnChanges {
