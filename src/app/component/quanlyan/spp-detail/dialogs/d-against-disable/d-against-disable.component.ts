...
@Component({
  selector: 'app-d-against-disable',
  templateUrl: './d-against-disable.component.html',
  styleUrls: ['./d-against-disable.component.scss']
})
export class DAgainstDisableComponent implements OnInit, OnChanges {
