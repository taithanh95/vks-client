...
@Component({
  selector: 'app-d-spp-damaged-disable',
  templateUrl: './d-spp-damaged-disable.component.html',
  styleUrls: ['./d-spp-damaged-disable.component.scss']
})
export class DSppDamagedDisableComponent implements OnInit, OnChanges {
