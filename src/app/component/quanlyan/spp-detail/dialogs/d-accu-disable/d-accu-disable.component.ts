...
@Component({
  selector: 'app-d-accu-disable',
  templateUrl: './d-accu-disable.component.html',
  styleUrls: ['./d-accu-disable.component.scss']
})
export class DAccuDisableComponent implements OnInit, OnChanges {
  ...
  submitArrestDetentionArrestee(data): void {
    ...
    for (const item of data.lawOffenses) {
      ...
      lawOffensesItem.LAWID = item.enactmentId;
      lawOffensesItem.ITEM = item.item;
      lawOffensesItem.POINT = item.point;
      lawOffensesItem.LAWNAME = item.enactmentName;
      lawOffensesItem.CODENAME = item.lawName;
      this.lstSavedLaw = [
        ...this.lstSavedLaw,
        lawOffensesItem
      ];
