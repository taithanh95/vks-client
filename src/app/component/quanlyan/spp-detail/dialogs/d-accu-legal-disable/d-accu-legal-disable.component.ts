...
@Component({
    selector: 'app-d-accu-legal-disable',
    templateUrl: './d-accu-legal-disable.component.html',
    styleUrls: ['./d-accu-legal-disable.component.scss']
})
export class DAccuLegalDisableComponent implements OnInit, OnChanges{
