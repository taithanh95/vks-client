...
@Component({
  selector: 'app-law-penalty-search',
  templateUrl: './law-penalty-search.component.html',
  styleUrls: ['./law-penalty-search.component.scss']
})
export class LawPenaltySearchComponent implements OnInit {
  /* Show Dialogs*/
  ...
  loadDataFromServer(): void {
    if (this.enabledAutoLoadData) {
      ...
      this.loading = true;
      this.generalService.searchLawPenalty(payload).subscribe(res => {
        if (res) {
