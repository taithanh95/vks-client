...
@Component({
  selector: 'app-result-appeal',
  templateUrl: './result-appeal.component.html',
  styleUrls: ['./result-appeal.component.scss']
})
export class ResultAppealComponent implements OnInit {
  ...
  doSearch(): void {
    ...
    this.loading = true;
    this.generalService.searchAppeal(payload).subscribe(res => {
      this.loading = false;
      this.data = res;
