...
@Component({
  selector: 'app-result-decision',
  templateUrl: './result-decision.component.html',
  styleUrls: ['./result-decision.component.scss']
})
export class ResultDecisionComponent implements OnInit {
  ...
  doSearch(): void {
    ...
    this.loading = true;
    this.generalService.searchDecision(payload).subscribe(res => {
      this.loading = false;
      this.data = res;
