...
@Component({
  selector: 'app-register-decisioin-case-lists',
  templateUrl: './register-decision-case-lists.component.html',
  styleUrls: ['./register-decision-case-lists.component.scss']
})
export class RegisterDecisionCaseListsComponent implements OnInit {
  ...
  private getSppByUserId(): void {
    ...
    const casecode = localStorage.getItem(Constant.SPP_CASECODE).toString();
    this.formSearch.get('caseCode').setValue(casecode);
